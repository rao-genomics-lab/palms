...
from tabs._helpers import StatusProxy, attach_tqdm_progress, qt_tqdm_context
...
def build_tab(ctx: ViewerContext) -> tuple:
    ...
    def _rebuild_annot_checkboxes():
        ...
        from utils.annotation_utils import get_annotation_types
    ...
    def _on_run():
        from utils.annotation_utils import sample_annotation_centroids
        import anndata
