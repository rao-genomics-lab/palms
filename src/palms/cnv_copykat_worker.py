...
Usage::
    ...
    python -m palms.cnv_copykat_worker <input_h5ad> <params_json> <output_dir>
"""
...
def main(argv: list[str]) -> int:
    if len(argv) != 3:
        print("usage: python -m palms.cnv_copykat_worker "
    ...
    try:
        ...
        import pandas as pd
        from palms.utils.cnv_analysis import run_cnv_pipeline, make_cnv_heatmap
