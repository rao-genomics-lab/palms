...
``palms.tabs`` own which blocks are selected and what the parameters
are; see :mod:`palms.utils.steps` for how a template becomes a single
...
from palms.utils.step_templates.loader import (
    TEMPLATE_PATH_ENV,
    ResolvedTemplate,
    TemplateError,
    builtin_assemble,
