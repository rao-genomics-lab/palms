...
from palms.utils.zarr_safe import safe_delete_element
...
from palms.utils.affine_linking import (
...
def build_tab(ctx: "ViewerContext"):
    ...
    def _on_loaded(result, display_name, path):
        ...
        ctx.record_node(
            ...
            f"from palms.utils.registration import load_multichannel_pyramid\n"
