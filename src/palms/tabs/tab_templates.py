...
from palms.tabs.tab_notebook import PythonSyntaxHighlighter
...
from palms.utils.step_templates.spec import BLOCK_MARKER, BlockSpec
from palms.utils.step_templates.validate import Problem
from palms.utils.steps import Step, StepError
