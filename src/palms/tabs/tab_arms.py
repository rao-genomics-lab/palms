...
def build_tab(ctx: ViewerContext) -> tuple:
    ...
    def _build_arms_flip_affine():
        ...
        if shape is None:
            return np.eye(3)
        return flip_matrix(shape, arms_flip_v.value, arms_flip_h.value)
    ...
    def on_arms_load_geojson():
        ...
        if ok and not no_cache:
            try:
                ...
                pass
            from palms.utils.adata_persistence import save_arms_tiles_to_sdata
    ...
    def on_arms_deg():
        ...
        ctx.record_node(
            ...
            f"import json\n"
            f"from palms.utils.adata_persistence import load_arms_tiles_from_sdata\n"
            f"from palms.utils.gene_analysis import compute_arms_tile_deg\n"
    ...
    def _on_arms_deg_ready(result):
        ...
        from palms.utils.adata_persistence import save_arms_tile_deg_to_sdata
