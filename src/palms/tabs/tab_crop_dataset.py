...
palms data directory (cropped morphology image, cell/nucleus labels,
...
from palms.tabs._helpers import make_tab, StatusProxy, make_progress_dialog
...
class _CropExportWorker(QThread):
    ...
    def run(self):
        from palms.utils.crop_export import crop_and_export, CropExportError
...
def build_tab(ctx: ViewerContext) -> tuple:
    ...
    instructions = QLabel(
        ...
        "transcripts + table) that can be opened directly with palms. "
