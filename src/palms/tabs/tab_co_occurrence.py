...
from palms.tabs._helpers import make_tab, StatusProxy, attach_tqdm_progress, qt_tqdm_context, make_progress_bar, combo_value_kwargs
from palms.utils.plot_output import recorded_save_code, safe_stem
...
def build_tab(ctx: ViewerContext) -> tuple:
    ...
    def _on_co_occurrence_ready(result):
        ...
        from palms.utils.adata_persistence import save_co_occurrence_to_adata
