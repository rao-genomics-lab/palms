...
from xenium_viewer.utils.step_templates.spec import TemplateSpec
from xenium_viewer.utils.steps import StepError, free_names, render
...
def validate(
    ...
    *builtin* is the shipped spec to compare against (structure, frozen blocks,
    ...
    for block in spec.blocks.values():
        if "xenium_viewer" in block.text:
            problems.append(Problem(
                "reaches back into xenium_viewer; the exported notebook has to "
