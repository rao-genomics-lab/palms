...
def build_tab(ctx: ViewerContext) -> tuple:
    ...
    def _persist():
        from xenium_viewer.utils.adata_persistence import save_annotations_to_sdata
    ...
    def _restore_session(session):
        from xenium_viewer.utils.adata_persistence import load_annotations_from_sdata
