...
| Palette: | Dropdown: "tab20", "glasbey_dark", "Set1", "Set3", or "ARMS (Set1+Set2+Dark2)". Applies the chosen colour palette to cluster colours. |
...
| Edge width: | Slider (0–20). Controls the thickness of patch outlines. |
...
| Cluster checkboxes | Scrollable grid of per-cluster checkboxes. Uncheck a cluster to hide its patches. |
